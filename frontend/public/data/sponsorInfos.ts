...
export const silverLinks: sponsorInfo[] = [
  ...
  },
  {
    ...
    alt: 'Quantium logo',
    description:
      "Quantium has developed a world-class data science and AI solution that has transformed the accuracy of Walmart's prediction of customers' needs at scale"
  },
  {
