        ...
        <div className="flex justify-center items-center">
          <div className="lg:grid grid-cols-6 flex-1 max-w-[90rem]">
            ...
            <div className="col-span-2 md:mx-5">
              ...
              <p className="text-[#727B8C] font-medium">
                unsw-computer-science-engineering-society
              </p>
              <a href="https://github.com/csesoc/" target="_blank">
                <button className="bg-[#444F6F] w-full my-5 py-2 rounded hover-animate">
                  Follow
                </button>
              </a>
              <p>CSESoc is the principal representative body for UNSW computing students.</p>
            ...
            <div className="col-span-4 lg:mt-0 mt-10">
              <div className="rounded border border-[#595F6D] p-5 h-auto">
                ...
                <div className="mt-5">
                  <p>
                    CSESoc is the official representative body of computing students at UNSW. We are
                    one of the largest and most active societies at UNSW, and the largest computing
                    society in the southern hemisphere. CSESoc comprises over 16k members spanning
                    across various degrees including Computer Science, Software Engineering,
                    Bioinformatics and Computer Engineering. We are here to fulfil the social,
                    personal and professional needs of CSE students, and promote computing through a
                    variety of forms.
                  </p>
                  <br />
                  <p>
                    We are a society for the students, by the students. Here’s an overview of what
                    we do:
                  </p>

                  <ul className="list-disc">
                    <li className="ml-6">
                      Run weekly social and educational events, including trivia, movie, boardgames
                      nights, LAN parties, workshops, coding competitions, tech talks, and our
                      famous free weekly BBQ
                    </li>
                    <li className="ml-6">
                      Create original media content, including Podcasts, articles, YouTube videos,
                      and live streams
                    </li>
                    <li className="ml-6">
                      Run a highly successful First Year Camp and Peer Mentoring program, offering
                      new CSE students (both undergraduate and postgraduate) a chance to meet and
                      mingle with other newcomers
                    </li>
                    <li className="ml-6">
                      Engage students with industry sponsors and representatives to develop their
                      professional capacity and curiosity
                    </li>
                    <li className="ml-6">
                      Develop our own open-source projects for students to get learn new skills and
                      develop tools for our community
                    </li>
                    <li className="ml-6">
                      Facilitate an online community of ~8k Discord users, ~9.5k Facebook followers,
                      ~1.9k YouTube subs, and ~7.7k Instagram followers
                    </li>
                  </ul>
                </div>
              </div>
